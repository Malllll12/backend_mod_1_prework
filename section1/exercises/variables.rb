...
# How did you decide to use the data type you did for each of the three variables above?
 #I used a string for first_name becacause it's an object. I used a boolean for is_hungry because it's a true false statement. I used  a number for number_of_pets because it's asking for a number.
# Explain. The varible name identifies what kind of data type to expect.
